...
const Checkout = () => {
  ...
  return (
    <div className="md:w-[85%] w-full mx-auto px-2 py-20">
      <h1 className="text-center text-4xl my-2 font-semibold text-gray-800">Checkout</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-5">
        <div className="md:col-span-2 bg-white shadow rounded-lg p-4">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-blue-500 text-white py-2.5 px-4 rounded-md hover:bg-blue-600 transition duration-300"
            >
              Complete Purchase
            </button>
          </form>
